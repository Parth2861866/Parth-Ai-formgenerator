  ...
  return (
    <div>
      <div className="text-center mb-16">
        ...
        <p className="text-gray-500 mt-3">Receive unlimited credits when you pay early, and save your plan</p>
      </div>
      <div className="grid grid-cols-3 gap-6">
        {pricingPlan.map((plan: PricingPlan, index: number) => (
          <Card
            className={`${
              plan.level === "Enterprise" && "bg-black text-white z-2" 
          ...
          >
            <CardHeader className="flex flex-row items-center gap-2">
              ...
              {plan.level === "Professional" &&  (
                <Badge className="rounded-full bg-orange-600 hover:bg-null text-base">
                  Popular 🔥
                </Badge>
              )}
            </CardHeader>
